...
<div class="layui-collapse" lay-filter="test">
    <div class="layui-colla-item">
        ...
        <div class="layui-colla-content">
            <p>
                易学：精心选择要培训的内容,课程内容清晰地给出了要学内容的主线</p>
 <p>动手：课程的所有部分都配有上机实验,培养学员的动手能力</p>
 <p>实用：课程内容反映了实际工作需要的内容,学员可应用课程中的内容到实际的工作中</p>
 <p>课件：自己编写课件,及时更新培训课件,使之紧跟当前的最新技术</p>
 <p>教师：通过建立具有丰富实践经验的师资队伍,保证培训目标的实现。</p>
        </div>
    </div>
    <div class="layui-colla-item">
