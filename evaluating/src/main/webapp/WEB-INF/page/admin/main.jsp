...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        ...
        <ul class="layui-nav" lay-filter="side-top-left">
            <!--<li class="layui-nav-item"><a href="javascript:;" href-url="${pageContext.request.contextPath}/main/btn.html"><i class="layui-icon">&#xe621;</i>按钮</a></li>
            <li class="layui-nav-item">
                <a href="javascript:;"><i class="layui-icon">&#xe621;</i>基础</a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" href-url="${pageContext.request.contextPath}/main/btn.html"><i class="layui-icon">&#xe621;</i>按钮</a></dd>
                    <dd><a href="javascript:;" href-url="${pageContext.request.contextPath}/main/form.html"><i class="layui-icon">&#xe621;</i>表单</a></dd>
                </dl>
            </li>-->
        </ul>
        ...
        <ul class="layui-nav my-header-user-nav" lay-filter="side-top-right">
            ...
            <li class="layui-nav-item">
                <a class="name" href="javascript:;"><img src="${pageContext.request.contextPath}/frame/static/image/code.png" alt="logo"> Admin </a>
                <dl class="layui-nav-child">
                    <dd><a href="javascript:;" href-url="${pageContext.request.contextPath}/main/login.html"><i class="layui-icon">&#xe621;</i>登录页</a></dd>
                    <dd><a href="javascript:;" href-url="${pageContext.request.contextPath}/main/map.html"><i class="layui-icon">&#xe621;</i>图表</a></dd>
        ...
        <div class="layui-tab layui-tab-card my-tab" lay-filter="card" lay-allowClose="true">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe id="iframe" src="${pageContext.request.contextPath}/main/welcome" frameborder="0"></iframe>
                </div>
            </div>
        </div>
    </div>
...
<div class="my-pay-box none">
    <div><img src="${pageContext.request.contextPath}/frame/static/image/zfb.png" alt="支付宝"><p>支付宝</p></div>
    <div><img src="${pageContext.request.contextPath}/frame/static/image/wx.png" alt="微信"><p>微信</p></div>
</div>
