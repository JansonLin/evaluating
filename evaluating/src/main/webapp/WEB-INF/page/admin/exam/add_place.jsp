...
<form class="layui-form" action="">
    ...
    <div class="layui-form-item">
        <div class="layui-inline">
            <label class="layui-form-label">考点名：</label>
            <div class="layui-input-inline">
                <input type="tel" name="eName" lay-verify="phone" placeholder="请输入考点名" autocomplete="off" class="layui-input">
            </div>
        </div>
        <div class="layui-inline">
            <label class="layui-form-label">考生数：</label>
            <div class="layui-input-inline">
                <input type="tel" name="eCount" lay-verify="phone" placeholder="请输入考生数" autocomplete="off" class="layui-input">
            </div>
        </div>
    </div>
   <div class="layui-form-item">
        <label class="layui-form-label">考点地址:</label>
        <div class="layui-input-block">
            <input type="text" name="identity" lay-verify="identity" placeholder="" autocomplete="off" class="layui-input">
        </div>
    </div>
	 <div class="layui-form-item layui-form-text">
        <label class="layui-form-label">可选考试</label>
        <div class="layui-input-block">
            <select name="modules" lay-verify="required" lay-search="">
                    <option value="">选择所属考试</option>
                    <option value="1">考试一</option>
                    <option value="0">考试二</option>
                </select>
        </div>
    </div>
    <div class="layui-form-item">
